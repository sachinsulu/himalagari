...
class Hotel extends DatabaseObject {
	...
	protected static $table_name = "tbl_hotel";
	protected static $db_fields = array('id', 'title', 'image', 'linksrc', 'linktype', 'content', 'status', 'sortorder','rating','slug','destination');
	...
	public static function getHotel_by(){
		global $db;
		
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE status=1  ORDER BY sortorder DESC LIMIT 3");
	}
