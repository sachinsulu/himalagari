...
class Vacency extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'title','slug', 'pax', 'content', 'status', 'meta_keywords', 'meta_description', 'date1', 'date2','archive_date', 'sortorder', 'type', 'added_date', 'image');
