...
class Faq extends DatabaseObject
{
    ...
    protected static $table_name = "tbl_faq";
    protected static $db_fields = array('id', 'title', 'title_gr', 'content', 'content_gr', 'status', 'sortorder', 'added_date');
    ...
    //Find all the rows in the current database table.
    public static function find_few($limit = 0)
    {
        global $db;
        return self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE status=1 ORDER BY sortorder DESC LIMIT $limit");
    }
