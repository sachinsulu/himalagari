<?php
class Meetup extends DatabaseObject {

	protected static $table_name = "tbl_meetup";
	protected static $db_fields = array('id', 'name', 'date1','date2', 'status', 'sortorder', 'address','image','time','content');
	...
	public static function get_allmeetup($limit=''){
		global $db;
