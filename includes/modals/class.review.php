...
class Review extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'name', 'address', 'country', 'comments', 'email', 'package_id', 'sortorder', 'status', 'homepage', 'myfile', 'title', 'gender', 'pretrip', 'meals', 'staffs', 'transportation', 'accomodation', 'money', 'image', 'rating', 'added_date');
    ...
    {
        global $db;
        return self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE package_id=$packageid AND status=1 ORDER BY sortorder DESC");
    }
