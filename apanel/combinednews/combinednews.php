                        ...
                        <div class="col-md-3" id="removeSavedimg<?php echo $combinednewsInfo->id; ?>">
                            ...
                            <span class="float-left">
                                ...
                                <img src="<?php echo IMAGE_PATH . 'combinednews/thumbnails/' . $combinednewsInfo->image; ?>"
                                     style="width:100%"/>
                                 <input type="hidden" name="imageArrayname" value="<?php echo !empty($combinednewsInfo->image) ? $combinednewsInfo->image : ""; ?>" class=""/>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (!empty($combinednewsInfo->gallery)):
                        ...
                        if ($imgall) {
                            foreach ($imgall as $imgk => $imgv) { ?>
                                <div class="col-md-3" id="removeSavedGallimg<?php echo $imgk; ?>">
                                    <div class="infobox info-bg">
                                        <div class="button-group" data-toggle="buttons">
                                <span class="float-left">
                                    <?php
                                    ...
                                    ?>
                                            ...
                                            <a class="btn small float-right" href="javascript:void(0);"
                                               onclick="deleteSavedgalleryimage('<?php echo $imgk; ?>');">
                                                <i class="glyph-icon icon-trash-o"></i>
                                            </a>
                                        </div>
