...
<div class="form-row"> 
<div class="col-md-6" id="previewUserimage<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'themes/thumbnails/'.$val;?>"  style="width:100%"/>
        ...
        <input type="hidden" name="bgimage" value="<?php echo IMAGE_PATH.'themes/'.$val;?>" class="validate[required,length[0,250]]" />        
    </div> 
</div>
</div>
...
//uplodify
  if(isset($_SESSION['imageNameArr'])){
   if(count($_SESSION['imageNameArr'])>0){
      ...
      { 
         @unlink(IMAGE_PATH.'articles/thumbnails/'.$val);
      	 @unlink(IMAGE_PATH.'articles/'.$val);
      }	 
