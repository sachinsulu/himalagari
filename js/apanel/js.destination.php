				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   if(actionId==2)
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>destination/list";},3000);						   	
						   if(actionId==1)	
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>destination/addEdit";},3000);						   	
						   if(actionId==0)
